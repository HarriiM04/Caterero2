					...
					?>
							<li class="header-cart-item flex-w flex-t m-b-12">
								...
								<div class="header-cart-item-txt p-t-8">
									...
									<a href="shoping-cart.php?id=<?php echo $row['id']?>" class="flex-c-m stext-55 cl0 size-50 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
										proceed
									</a>

									<a href="remove_from_cart.php?id=<?php echo $row['id']?>" class="flex-c-m stext-101 cl0 size-55 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
										remove
									</a>
								</div>
							</li>
